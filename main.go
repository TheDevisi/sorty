...
// main initializes the Sorty application, verifies configuration, sets up auto-start, starts the directory watcher asynchronously, and initializes the system tray interface.
func main() {
